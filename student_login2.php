...
<div class="container-fluid form">
  ...
  font-size: 20px;">
                      ...
                      <li style=" margin: 10px;"><input type="text" name="email" required placeholder="Enter your Email-Id" class="form-control form2" ></li>
                       <div class="clear"></div>
                      <li style=" margin: 10px;">Password</li>
                      <li style=" margin: 10px;"><input type="password"  name="pass" required placeholder="Enter your password" class="form-control form2"></li>
  ...
  border-radius: 20px;" /></li>
                      ...
                      <div class="clear"></div>
                                  ...
                                  <li style=" margin: 10px;"><a href="student_register2.php" ><input type="submit"  name="login"  value="New? Register Here !!" style="margin-top: 30px;
